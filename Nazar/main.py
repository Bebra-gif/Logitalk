...
def receive_message(username, message, from_self: bool = False):
    ...
    bg_color = "cadetblue" if from_self else "#5b42db"
...
chatFrame = CTkScrollableFrame(window, height=275, label_text="LogiTalk", label_font=("Arial", 20, "normal"), label_fg_color="cadetblue", fg_color="lightblue")
chatFrame.pack(fill="x", expand=True)

inputFrame = CTkFrame(window, height=50)
